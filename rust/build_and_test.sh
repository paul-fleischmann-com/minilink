...
# Testprogramm (../test/main.c, ../test/msg.c) in drei Varianten, genau wie
# das C-Original (siehe ../build_and_test.sh):
#
...
#
# Objektdateien liegen direkt im Varianten-Ordner (unter rust/test/),
# die fertigen Executables unter rust/test/<variante>/out/.
...
"$BIN" -T ../test/default.ldl            test/none/main.o test/none/msg.o -o test/none/out/program

echo "==> [4/5] Linken -- test/lsl/out (--lsl)  und  test/g/out (-T --debug)"
"$BIN" --lsl ../test/tc27x.lsl           test/lsl/main.o  test/lsl/msg.o  -o test/lsl/out/program
"$BIN" -T ../test/default.ldl --debug    test/g/main.o    test/g/msg.o    -o test/g/out/program
